...
'''
    ...
    buttons.buildbutton("Repo", "https://telegra.ph/JJBA-05-16")
    buttons.buildbutton("Channel", "https://telegra.ph/JJBA-05-16")
...
def main():
    ...
    if os.path.isfile(".restartmsg"):
        ...
        bot.edit_message_text("Up Successfully", chat_id, msg_id)
